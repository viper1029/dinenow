...
public class KeywordResource extends AbstractResource<Keyword> {

  @GET
  @ApiOperation("get list of all keywords for ADMIN and OWNER")
  @ApiResponses(value = {
  ...
  @GET
  @Path("/{id}")
  @ApiOperation("api get detail of keyword")
  @ApiResponses(value = {
      @ApiResponse(code = 200, message = "data"),
  ...
  @POST
  @ApiOperation(value = "api add new keyword")
  @ApiResponses(value = {
      @ApiResponse(code = 200, message = "data"),
      @ApiResponse(code = 401, message = "Access denied for user"),
  ...
  @Override
  protected Response onCreate(User access, Keyword entity, Restaurant restaurant) {
    if (restaurant != null) {
  ...
  @Override
  protected Keyword getEntityForInsertion(HashMap<String, Object> inputMap) {
    Keyword entity = super.getEntityForInsertion(inputMap);
    entity.setKeyword(inputMap.get("keyword").toString());
    return entity;
  }

  @PUT
  @ApiOperation(value = "update keyword")
  @Path("/{id}")
  @ApiResponses(value = {
      @ApiResponse(code = 200, message = "data"),
  ...
  @DELETE
  @Path("/{id}")
  @ApiOperation("delete keyword by id")
  @ApiResponses(value = {
