...
var dineNowApp = angular.module("common.config", [])
    .constant("ROOT", "http://ec2-54-213-249-95.us-west-2.compute.amazonaws.com:30505/api/v1/")
    .constant("API_IMAGE_UPLOAD", "http://ec2-54-213-249-95.us-west-2.compute.amazonaws.com:30505/api/v1/images/");

dineNowApp.module('app.controllers',[
