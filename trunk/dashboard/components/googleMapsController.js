        ...
        $scope.polylinesMapInstance,
            ...
            $scope.$on("GMaps:created", function(event, mapInstance) {
                ...
                mapInstance.key && ($scope[mapInstance.key] = mapInstance.map),
                    "fusionMapInstance" == mapInstance.key ? $scope.fusionMapInstance.loadFromFusionTables({
                        query: {
                    ...
                    }) : "polylinesMapInstance" == mapInstance.key ? $scope.polylinesMapInstance.drawPolyline({
                        path: path,
                        strokeColor: "#131540",
                        strokeOpacity: .6,
                        strokeWeight: 6
