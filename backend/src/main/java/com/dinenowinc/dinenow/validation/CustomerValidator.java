...
public class CustomerValidator {
    ...
    public CustomerValidator(CustomerService customservice, RestaurantUserService restaurantUserService, Customer c) {
    ...
    public ServiceErrorValidationMessage validateForCreation() {
        ...
        if (customService.getUserByEmail(customer.getEmail()) != null || restaurantUserService.getUserByEmail(customer.getEmail()) != null) {
        	errors.addError("Email exist");
        }
        
        if (customService.phoneExist(customer.getPhoneNumber())) {
        	errors.addError("Phone number exist");
		}
